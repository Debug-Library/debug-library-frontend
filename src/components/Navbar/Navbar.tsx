...
const Navbar = () => {
   ...
   // Simulação de autenticação caso o usuário esteja autenticado ou não  
    ...
    const linkStyle = "text-white font-bold hover:text-yellow-300 transition-colors duration-300";
        ...
        <nav className="bg-purple-400 px-6 py-5">
            <div className="flex items-center justify-between">
                ...
                <div className="md:hidden">
                    <button onClick={toggleMenu} className="text-white text-2xl transition-transform duration-300">
